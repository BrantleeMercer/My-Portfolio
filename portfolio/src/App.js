...
function App() {
    ...
    <div className="App">
      ...
      <div className={"Info-Body"}>
          <InformationContainer courseTitle={spaceInfo.courseTitle} courseDescription={spaceInfo.courseDescription} dateCompleted={spaceInfo.completionDate}/>
          <InformationContainer courseTitle={beautifulGamesInfo.courseTitle} courseDescription={beautifulGamesInfo.courseDescription} dateCompleted={beautifulGamesInfo.completionDate}/>
      </div>
    </div>
);
}
